(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();const md="/plant-bud/assets/add-DfPL7aol.png",gd="/plant-bud/assets/home-CrrGhyeF.png",_d="/plant-bud/assets/plant-BhAigKyc.png",yd="/plant-bud/assets/quiz-_3H2ladB.png",Ed="/plant-bud/assets/search-BxN_USk1.png",vd="/plant-bud/assets/add-DsYdsqZN.png",Id="/plant-bud/assets/home-C9ONuVPF.png",Td="/plant-bud/assets/plant-aWTnh3ZP.png",wd="/plant-bud/assets/quiz-6MWY4zf-.png",Ad="/plant-bud/assets/search-BdxZNR9F.png",Rd="/plant-bud/assets/added-icon-CKuvKSNF.png",bd="/plant-bud/assets/archive-icon-BZQVfEXH.png",qv=(n,e)=>n.filter(r=>r.id!==e),jv=(n,e)=>n.find(r=>r.id===e),$v=(n,...e)=>{e.forEach(t=>{n.contains(t)&&n.removeChild(t)})},$r=(n,...e)=>{e.forEach(t=>{t&&n.appendChild(t)})},zv=(...n)=>{n.forEach(e=>{e&&(e.classList.add("hidden"),e.classList.remove("flex"))})},Hv=(n,...e)=>{e.forEach(t=>{t&&(t.style.display=`${n}`)})},Wv=(n,e)=>{let t=n.slice(0),r=n.length,i,s;for(;r--;)s=Math.floor((r+1)*Math.random()),i=t[s],t[s]=t[r],t[r]=i;return t.slice(0,e)},Gv=()=>{const n=new Date,e=String(n.getDate()).padStart(2,"0"),t=String(n.getMonth()+1).padStart(2,"0"),r=n.getFullYear();return e+"/"+t+"/"+r},Kv=async()=>new Promise((n,e)=>{navigator.geolocation?navigator.geolocation.getCurrentPosition(t=>{const{latitude:r,longitude:i}=t.coords;n({latitude:r,longitude:i})},t=>{e(t)}):e(new Error("Geolocation is not supported by this browser."))}),Qv=n=>Math.round(n),Xv=n=>n instanceof File,Yv=()=>{let n=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${n}px`)},Yt=({tagName:n="",placeholder:e="",textContent:t="",classEl:r=[],id:i="",value:s="",type:a="",fr:u="",dataAttributes:l={},ariaLabel:d="",alt:p=""})=>{const y=document.createElement(n);return e&&(y.placeholder=e),t&&(y.textContent=t),r&&r.forEach(w=>y.classList.add(w)),i&&(y.id=i),s&&(y.value=s),a&&(y.type=a),u&&(y.htmlFor=u),d&&y.setAttribute("aria-label",d),n==="img"&&p&&(y.alt=p),Object.keys(l).forEach(w=>{y.setAttribute(`data-${w}`,l[w])}),y},Jv=()=>{let n="";const e=Yt({tagName:"div",classEl:["menu-dots-container"]});return n=Yt({tagName:"div",classEl:["menu-dot"]}),$r(e,n),n=Yt({tagName:"div",classEl:["menu-dot"]}),$r(e,n),n=Yt({tagName:"div",classEl:["menu-dot"]}),$r(e,n),e},Zv=n=>{const e=Yt({tagName:"div",classEl:["added-to-plants-icon","back-button"]}),t=Yt({tagName:"img"}),r=n==="ADDED"?Rd:bd;return t.src=r,$r(e,t),e};var ja={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(_f(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function _f(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Is="@firebase/app",Ga="0.10.7";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dt=new zs("@firebase/app"),yf="@firebase/app-compat",Ef="@firebase/analytics-compat",vf="@firebase/analytics",If="@firebase/app-check-compat",Tf="@firebase/app-check",wf="@firebase/auth",Af="@firebase/auth-compat",Rf="@firebase/database",bf="@firebase/database-compat",Pf="@firebase/functions",Sf="@firebase/functions-compat",Cf="@firebase/installations",kf="@firebase/installations-compat",Df="@firebase/messaging",Nf="@firebase/messaging-compat",Of="@firebase/performance",Vf="@firebase/performance-compat",Lf="@firebase/remote-config",Mf="@firebase/remote-config-compat",xf="@firebase/storage",Uf="@firebase/storage-compat",Ff="@firebase/firestore",Bf="@firebase/vertexai-preview",qf="@firebase/firestore-compat",jf="firebase",$f="10.12.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ri(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Kn(n,Ru(t,{idToken:r}));M(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?bu(s.providerUserInfo):[],u=Ep(n.providerData,a),l=n.isAnonymous,d=!(n.email&&s.passwordHash)&&!(u!=null&&u.length),p=l?d:!1,y={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:u,metadata:new Rs(s.createdAt,s.lastLoginAt),isAnonymous:p};Object.assign(n,y)}async function yp(n){const e=ee(n);await ri(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Ep(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function bu(n){return n.map(e=>{var{providerId:t}=e,r=Gs(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pu{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Pu.type="NONE";const nc=Pu;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bp(n,e={}){return It(n,"GET","/v2/passwordPolicy",vt(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qu(n,e,t=!1){if(Me(n.app))return Promise.reject(Ye(n));const r="signIn",i=await Fu(n,r,e),s=await Vt._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function Yp(n,e){return qu(qt(n),e)}async function eI(n,e){return Bu(ee(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ju(n){const e=qt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function tI(n,e,t){if(Me(n.app))return Promise.reject(Ye(n));const r=qt(n),a=await bs(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Qp).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&ju(n),l}),u=await Vt._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(u.user),u}function nI(n,e,t){return Me(n.app)?Promise.reject(Ye(n)):Yp(ee(n),hn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&ju(n),r})}function Jp(n,e,t,r){return ee(n).onIdTokenChanged(e,t,r)}function Zp(n,e,t){return ee(n).beforeAuthStateChanged(e,t)}function em(n,e,t,r){return ee(n).onAuthStateChanged(e,t,r)}function rI(n){return ee(n).signOut()}async function iI(n){return ee(n).delete()}const si="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cr(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==Sg)throw n;V("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ci{constructor(e,t){this.position=e,this.inclusive=t}}function Rc(n,e,t){let r=0;for(let i=0;i<n.position.length;i++){const s=e[i],a=n.position[i];if(s.field.isKeyField()?r=L.comparator(L.fromName(a.referenceValue),t.key):r=on(a,t.data.field(s.field)),s.dir==="desc"&&(r*=-1),r!==0)break}return r}function bc(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!$e(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N_{constructor(e){this.ct=e}}function O_(n){const e=b_({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Vs(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pi(n){return new y_(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function av(n){if(n.length===0)return null;const e=n.lastIndexOf("/");return e===-1?"":n.slice(0,e)}function cv(n,e){const t=e.split("/").filter(r=>r.length>0).join("/");return n.length===0?t:n+"/"+t}function bh(n){const e=n.lastIndexOf("/",n.length-2);return e===-1?n:n.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uv(n,e){return e}class be{constructor(e,t,r,i){this.server=e,this.local=t||e,this.writable=!!r,this.xform=i||uv}}let jr=null;function lv(n){return!Mo(n)||n.length<2?n:bh(n)}function Ph(){if(jr)return jr;const n=[];n.push(new be("bucket")),n.push(new be("generation")),n.push(new be("metageneration")),n.push(new be("name","fullPath",!0));function e(s,a){return lv(a)}const t=new be("name");t.xform=e,n.push(t);function r(s,a){return a!==void 0?Number(a):a}const i=new be("size");return i.xform=r,n.push(i),n.push(new be("timeCreated")),n.push(new be("updated")),n.push(new be("md5Hash",null,!0)),n.push(new be("cacheControl",null,!0)),n.push(new be("contentDisposition",null,!0)),n.push(new be("contentEncoding",null,!0)),n.push(new be("contentLanguage",null,!0)),n.push(new be("contentType",null,!0)),n.push(new be("metadata","customMetadata",!0)),jr=n,jr}function hv(n,e){function t(){const r=n.bucket,i=n.fullPath,s=new ke(r,i);return e._makeStorageReference(s)}Object.defineProperty(n,"ref",{get:t})}function dv(n,e,t){const r={};r.type="file";const i=t.length;for(let s=0;s<i;s++){const a=t[s];r[a.local]=a.xform(r,e[a.server])}return hv(r,n),r}function Sh(n,e,t){const r=Rh(e);return r===null?null:dv(n,r,t)}function fv(n,e,t,r){const i=Rh(e);if(i===null||!Mo(i.downloadTokens))return null;const s=i.downloadTokens;if(s.length===0)return null;const a=encodeURIComponent;return s.split(",").map(d=>{const p=n.bucket,y=n.fullPath,w="/b/"+a(p)+"/o/"+a(y),b=Li(w,t,r),k=Ih({alt:"media",token:d});return b+k})[0]}function pv(n,e){const t={},r=e.length;for(let i=0;i<r;i++){const s=e[i];s.writable&&(t[s.server]=n[s.local])}return JSON.stringify(t)}class Uo{constructor(e,t,r,i){this.url=e,this.method=t,this.handler=r,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ft{constructor(e,t){this._service=e,t instanceof ke?this._location=t:this._location=ke.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Ft(e,t)}get root(){const e=new ke(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return bh(this._location.path)}get storage(){return this._service}get parent(){const e=av(this._location.path);if(e===null)return null;const t=new ke(this._location.bucket,e);return new Ft(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw FE(e)}}function Av(n,e,t){n._throwIfRoot("uploadBytes");const r=Iv(n.storage,n._location,Ph(),new lt(e,!0),t);return n.storage.makeRequestWithTokens(r,Fo).then(i=>({metadata:i,ref:n}))}function Rv(n){n._throwIfRoot("getDownloadURL");const e=_v(n.storage,n._location,Ph());return n.storage.makeRequestWithTokens(e,Fo).then(t=>{if(t===null)throw xE();return t})}function bv(n){n._throwIfRoot("deleteObject");const e=yv(n.storage,n._location);return n.storage.makeRequestWithTokens(e,Fo)}function Pv(n,e){const t=cv(n._location.path,e),r=new ke(n._location.bucket,t);return new Ft(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
