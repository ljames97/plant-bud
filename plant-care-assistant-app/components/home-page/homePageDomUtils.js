...
const setWeatherIcon = (weatherDescription, weatherIcon) => {
  const weatherIcons = {
    clear: '../../public/weather-icons/clear.png',
    clouds: '../../public/weather-icons/clouds.png',
    rain: '../../public/weather-icons/rain.png',
    drizzle: '../../public/weather-icons/drizzle.png',
    thunderstorm: '../../public/weather-icons/thunderstorm.png',
    snow: '../../public/weather-icons/snow.png'
  }

  const iconPath = weatherIcons[weatherDescription.toLowerCase()] || '../../public/weather-icons/clouds.png';
